      ...
      columnDefs: [
        {
          ...
          cellTemplate: '<div class="ui-grid-cell-contents draggable" data-drag="true" jqyoui-draggable="{ index: {{rowRenderIndex}} }" data-entity="{{row.entity}}" data-jqyoui-options="{ helper: \'clone\', scroll: false, appendTo: \'body\', containment: \'window\', refreshPositions: true, opacity: 0.35, distance: 10 }" >{{COL_FIELD CUSTOM_FILTERS}}</div>',
